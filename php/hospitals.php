...
$Mansoura_hospitals = mysqli_fetch_all($result);

$sql = "SELECT hospital FROM hospitals WHERE city = 'Cairo' ";
$result = mysqli_query($db,$sql);
$Cairo_hospitals = mysqli_fetch_all($result);

$sql = "SELECT hospital FROM hospitals WHERE city = 'Port said' ";
$result = mysqli_query($db,$sql);
$port_hospitals = mysqli_fetch_all($result);

$sql = "SELECT hospital FROM hospitals WHERE city = 'Alexandria' ";
$result = mysqli_query($db,$sql);
$Alexandria_hospitals = mysqli_fetch_all($result);
